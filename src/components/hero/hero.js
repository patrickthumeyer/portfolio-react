      ...
      <div className="heroTopWrapper">
        ...
        <div className="descriptionContainer">
          ...
          <div className="description">
            I'm a Frontend Developer based in Berlin. In early 2018 I decided it
            was time for a change. My job as a Business Development Manager in
            Marketing was lacking the potential to inspire me in the long run. I
            decided to jump into Web Development in order to learn a new skill
            which also holds the potential to benefit from my former experience
            and gives me a clearer purpose of what I’m working towards in an
            organization. I am very excited to tackle all the new problems being
            thrown my way and to dive deeper into the world of Web Development.
          </div>
